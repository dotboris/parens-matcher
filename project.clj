(defproject parens-matcher "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :compiler {:main parens-matcher.core
                           ...
                           :output-to "resources/public/js/compiled/parens_matcher.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/parens_matcher.js"
                           :main parens-matcher.core
